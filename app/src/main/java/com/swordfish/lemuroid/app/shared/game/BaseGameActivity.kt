...
abstract class BaseGameActivity : ImmersiveActivity(), BusyActivity {
    ...
    protected var baseGameScreenViewModel: BaseGameScreenViewModel? = null

    protected val startGameTime = System.currentTimeMillis()
...
//        game = intent.getSerializableExtra(EXTRA_GAME) as Game
        val outFile = File(this.filesDir, "10001.nes")
...
//        )
    ...
    public fun createViewModel(game: Game) : BaseGameScreenViewModel {
        this.game = game
        systemCoreConfig = runBlocking { gameInteractor.getGameLauncher().getCoresSelection().getCoreConfigForSystem(GameSystem.findById(game!!.systemId)); }
    ...
    public fun createViewModel(gameId: Int,gameUri: String,gameName: String, systemId: String) : BaseGameScreenViewModel {
        ...
        return createViewModel(g)

    }

    public fun getViewModel(): BaseGameScreenViewModel {
